...
// end::spotify-unlike-json-docs[]

void websocketEvent(WStype_t type, uint8_t* payload, size_t length) {
  switch (type) {
    case WStype_CONNECTED:
      Serial.println("WS_CONNECTED");
      sendSpotifyUnlikeCurrentTrackJson(webSocket);
      break;
    case WStype_TEXT:
      handleSpotifyUnlikeCurrentTrackJsonResponse(payload, length);
      break;
    default:
      break;
  }
